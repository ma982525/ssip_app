...
export const TotalUnit = ({
  ...
  return (
    <View>
      <Text style={styles.TextInput}> Consumption in Units : {(lastPower!=null)?(parseInt(lastPower * hour))/1000:0}</Text>
      <Text style={styles.TextInput}> Consumption in Rupees : ₹ {(lastPower!=null)?(parseInt((lastPower * hour) * 7.10 ))/1000:0}</Text>
    </View>
  )
}
