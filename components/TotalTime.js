...
export const Totaltime = ({
  ...
  return (
    <View
      style={sty.rt}>
      <View style={[{ width: "80%", justifyContent: "center", paddingLeft: 20,flex: 1,flexDirection: 'row',justifyContent:"center",alignSelf:'center'}]}>
        <Text style={{ color: COLORS.white }}> Total Time On :  </Text>
           <Text style={{ color: COLORS.white, width: "80%"}}>{hour}h {Minuites}m {secound}s</Text>
      </View>
    </View>
  );
};
